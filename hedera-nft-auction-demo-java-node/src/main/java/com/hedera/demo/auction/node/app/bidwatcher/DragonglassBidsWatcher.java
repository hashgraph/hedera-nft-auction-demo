...
public class DragonglassBidsWatcher extends AbstractBidsWatcher implements BidsWatcherInterface {
    ...
    public DragonglassBidsWatcher(WebClient webClient, AuctionsRepository auctionsRepository, BidsRepository bidsRepository, int auctionId, String refundKey, int mirrorQueryFrequency) throws Exception {
