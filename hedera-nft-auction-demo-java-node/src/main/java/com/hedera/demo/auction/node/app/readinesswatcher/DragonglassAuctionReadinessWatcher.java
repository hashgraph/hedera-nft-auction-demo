...
public class DragonglassAuctionReadinessWatcher extends AuctionReadinessWatcher implements AuctionReadinessWatcherInterface {
    ...
    public DragonglassAuctionReadinessWatcher(HederaClient hederaClient, WebClient webClient, AuctionsRepository auctionsRepository, BidsRepository bidsRepository, Auction auction, String refundKey, int mirrorQueryFrequency) {
