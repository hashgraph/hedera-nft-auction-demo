 ...
 */
package com.hedera.demo.auction.web.db.tables;


import com.hedera.demo.auction.web.db.Indexes;
import com.hedera.demo.auction.web.db.Keys;
import com.hedera.demo.auction.web.db.Public;
...
public class FlywaySchemaHistory extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 430672271;
