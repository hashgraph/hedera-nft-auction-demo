...
public class PostAuctionAccountApiTest extends AbstractIntegrationTest {
  ...
  private void basicRequestCreateAuctionAccount() {
    ...
    requestCreateAuctionAccount.initialBalance = 100;
    var requestCreateAuctionAccountKeys = new RequestCreateAuctionAccountKeys();
    var requestCreateAuctionAccountKey = new RequestCreateAuctionAccountKey();

    requestCreateAuctionAccountKey.key = PrivateKey.generateED25519().getPublicKey().toString();
