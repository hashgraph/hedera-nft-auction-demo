...
public class DragonglassWinnerTokenTransfer extends AbstractWinnerTokenTransfer implements WinnerTokenTransferInterface {
    ...
    public DragonglassWinnerTokenTransfer(WebClient webClient, AuctionsRepository auctionsRepository, String tokenId, String winningAccountId) throws Exception {
